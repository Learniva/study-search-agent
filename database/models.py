"""
Database models for Multi-Agent Study & Grading System.

Uses SQLAlchemy with PostgreSQL for long-term storage of:
- Grading history (scores, feedback, rubrics)
- Professor configurations (rubric templates, preferences)
- Student submissions metadata
- Audit logs
"""
